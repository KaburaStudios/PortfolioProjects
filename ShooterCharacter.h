...
protected:
	...
	*/
	...
	/** Called when the Ability E Button is pressed */
	void AbilityEStart();
...
private:
	...
	/** Montage for weapon equip animations */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Combat, meta = (AllowPrivateAccess = "true"))
	...
	/** Randomized explosion sound cue */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Combat, meta = (AllowPrivateAccess = "true"))
	class USoundCue* AbilityESound;

	/** Flash spawned at OrbTarget */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Combat, meta = (AllowPrivateAccess = "true"))
	class UParticleSystem* AbilityEFlash;

	/** Montage for using Ability E */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Combat, meta = (AllowPrivateAccess = "true"))
	class UAnimMontage* AbilityEFireMontage;

	/** Particles spawned upon Ability E impact */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Combat, meta = (AllowPrivateAccess = "true"))
	UParticleSystem* AbilityE_ImpactParticles;
