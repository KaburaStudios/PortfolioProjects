...
void ASGameModeBase::SpawnBotTimerElapsed()
{
	...
	{
		UE_LOG(LogTemp, Log, TEXT("At maximum hot capacity. skipping bot spawn."));
		return;
	}
...
void ASGameModeBase::OnBotSpawnQueryCompleted(UEnvQueryInstanceBlueprintWrapper* QueryInstance, EEnvQueryStatus::Type QueryStatus)
{
	...
	{
		UE_LOG(LogTemp, Warning, TEXT("Spawn Bots Query EQS Failed!"));
		return;
	}
...
{
	UE_LOG(LogTemp, Log, TEXT("OnActorKilled: Victim: %s"), *GetNameSafe(VictimActor), *GetNameSafe(Killer));
